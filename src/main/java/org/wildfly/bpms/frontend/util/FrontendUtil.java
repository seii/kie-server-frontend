...
public class FrontendUtil {
	...
	/**
	 * Convert a specifically formatted <pre>String</pre> into a <pre>List\<String\></pre>
	 * @param values <pre>String</pre> in the format "value1[separator]value2[separator]..."
	 * @param separator <pre>String</pre> used to separate values
	 * @return <pre>List\<String\></pre> created from <pre>String</pre>
	 */
	...
	/**
	 * Convert a <pre>String</pre> to a <pre>Date</pre> object
	 * @param dateString <pre>String</pre> in the format "MM-dd-yyyy"
	 * @return <pre>Date</pre> object created from <pre>String</pre>
	...
	/**
	 * Convert a specifically formatted </pre>String</pre> into a <pre>Map\<String, Object\></pre>
	 * @param values <pre>String</pre> in the format "key1[objSeparator]value1[strSeparator]key2[objSeparator]value2[strSeparator]..."
	 * @param strSeparator <pre>String</pre> used to separate objects
	 * @param objSeparator <pre>String</pre> used to separate key/value pairs
	 * @return <pre>Map\<String, Object\></pre> constructed from the provided <pre>String</pre>
	 * @throws BpmsFrontendException
	 */
	...
	/**
	 * Accept a class name and convert it to a concrete instance of that class. If the full package format is not included (i.e. "java.util.List"), will try to add <pre>java.lang</pre> and see if it's a basic type.
	 * @param className Name of Java class (including package) in <pre>String</pre> format. Is case-sensitive, and must be exact.
	 * @return <pre>Object</pre> containing the specified class
	 * @throws BpmsFrontendException
	 */
	public static Object createObjFromClassName(String className) throws BpmsFrontendException {
		...
		try {
			...
			String errorMessage = String.format("Error accessing class %s. Error is:%n%s%n", className, e.getStackTrace());
			throw new BpmsFrontendException(errorMessage);
		}
	 ...
	 * @param format Formatting string, in <pre>String.format()</pre> style
	 * @param args Additional arguments to be used by formatting string
	 * @return Lines read from user input, in <pre>String</pre> format
	 * @throws BpmsFrontendException
	 */
	/*
	 ...
	 * <strong>WARNING:</strong> Typing passwords into a pseudo-console using this method may not hide the password!
	 * @param format Formatting string, in <pre>String.format()</pre> style
	 * @param args Additional arguments to be used by formatting string
	 * @return Password read from user input, in <pre>String</pre> format
	 * @throws BpmsFrontendException
	 */
